//
// Created by hjimce on 17-3-26.
//

#ifndef ANDROID_IMAGE_NDK_FACE_DETECTION_H
#define ANDROID_IMAGE_NDK_FACE_DETECTION_H

#endif //ANDROID_IMAGE_NDK_FACE_DETECTION_H
#include <jni.h>
#include <string>
#include <vector>
#include <iostream>
...
extern "C" jintArray  Java_image_imageapp_MainActivity_facedetection(JNIEnv *env, jobject /* this */
